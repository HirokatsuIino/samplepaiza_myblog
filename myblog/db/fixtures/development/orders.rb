...
csv.each do |line|
  ...
  office_id = line[2]
  request_unit_price = line[3]
  unit_price_id = line[4]
  ...
  Order.seed_once(:id) do |s|
    ...
    s.request_unit_price = request_unit_price
...
# id, document_request_id, office_id, request_unit_price, unit_price_id, unit_price_relation_type_id, pushed_thanks_page_action_button_id, order_request_no_applicate_flg, order_request_no_applicate_reson_id
